...
let modulePaths = {
 ...
 "packages/clipboard_manager/clipboard_manager": "packages/clipboard_manager/clipboard_manager.ddc",
 ...
 "packages/resume/custom_icons": "packages/resume/custom_icons.ddc",
 "packages/resume/main": "packages/resume/main.ddc",
 "packages/resume/main_web_entrypoint": "packages/resume/main_web_entrypoint.ddc",
 "packages/resume/resume": "packages/resume/resume.ddc",
 "packages/resume/util": "packages/resume/util.ddc",
...
define("main_web_entrypoint.dart.bootstrap", ["packages/resume/main_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:resume/main_web_entrypoint.dart") {
          // Clear static caches.
