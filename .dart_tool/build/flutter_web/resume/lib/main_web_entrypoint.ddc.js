define(['dart_sdk', 'packages/resume/main'], function(dart_sdk, packages__resume__main) {
  'use strict';
  ...
  const main = packages__resume__main.main;
  ...
  dart.trackLibraries("packages/resume/main_web_entrypoint", {
    "package:resume/main_web_entrypoint.dart": main_web_entrypoint
  }, {
