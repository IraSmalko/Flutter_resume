define(['dart_sdk'], function(dart_sdk) {
  ...
  (src__physics__clamped_simulation.ClampedSimulation.new = function(simulation, opts) {
    ...
    this[dxMin$] = dxMin;
    this[dxMax$] = dxMax;
    if (!(simulation != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/physics/clamped_simulation.dart", 28, 16, "simulation != null");
    if (!(dart.notNull(xMax) >= dart.notNull(xMin))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/physics/clamped_simulation.dart", 29, 16, "xMax >= xMin");
    if (!(dart.notNull(dxMax) >= dart.notNull(dxMin))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/physics/clamped_simulation.dart", 30, 16, "dxMax >= dxMin");
  ...
  src__physics__friction_simulation.FrictionSimulation = class FrictionSimulation extends src__physics__simulation.Simulation {
    static through(startPosition, endPosition, startVelocity, endVelocity) {
      if (!(startVelocity === 0.0 || endVelocity === 0.0 || startVelocity[$sign] === endVelocity[$sign])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/physics/friction_simulation.dart", 45, 12, "startVelocity == 0.0 ||\r\n        endVelocity == 0.0 ||\r\n        startVelocity.sign == endVelocity.sign");
      if (!(startVelocity[$abs]() >= endVelocity[$abs]())) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/physics/friction_simulation.dart", 48, 12, "startVelocity.abs() >= endVelocity.abs()");
      if (!((dart.notNull(endPosition) - dart.notNull(startPosition))[$sign] === startVelocity[$sign])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/physics/friction_simulation.dart", 49, 12, "(endPosition - startPosition).sign == startVelocity.sign");
  ...
  (src__physics__friction_simulation.BoundedFrictionSimulation.new = function(drag, position, velocity, _minX, _maxX) {
    this[_minX$] = _minX;
    this[_maxX$] = _maxX;
    if (!(position[$clamp](_minX, _maxX) === position)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter_web/src/physics/friction_simulation.dart", 115, 16, "position.clamp(_minX, _maxX) == position");
